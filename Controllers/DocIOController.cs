...
namespace SyncfusionMvcApplication1.Controllers
{
    public class DocIOController : Controller
    {
        ...
        public ActionResult DocIOFeatures(string Group1)
        {
            if (Group1 == null)
                return View();
            string dataPath3 = Server.MapPath("~\\App_Data\\DocIO\\");
            ...
            WPicture picture = paragraph.AppendPicture(System.Drawing.Image.FromFile(System.IO.Path.Combine(dataPath3, "AdventureCycle.jpg"))) as WPicture;
            ...
            picture = paragraph.AppendPicture(System.Drawing.Image.FromFile(System.IO.Path.Combine(dataPath3, "Mountain-200.jpg"))) as WPicture;
            ...
            paragraph.ParagraphFormat.LineSpacing = 12f;
            //Appends picture to the paragraph.
            picture = paragraph.AppendPicture(System.Drawing.Image.FromFile(System.IO.Path.Combine(dataPath3, "Mountain-300.jpg"))) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
            picture.VerticalOrigin = VerticalOrigin.Paragraph;
            ...
            paragraph.ParagraphFormat.LineSpacing = 12f;
            //Appends picture to the paragraph.
            picture = paragraph.AppendPicture(System.Drawing.Image.FromFile(System.IO.Path.Combine(dataPath3, "Road-550-W.jpg"))) as WPicture;
            picture.TextWrappingStyle = TextWrappingStyle.TopAndBottom;
            picture.VerticalOrigin = VerticalOrigin.Paragraph;
            ...
            else if (Group1 == "Pdf")
            {
                ...
                return pdfDoc.ExportAsAction_Result("sample.pdf", HttpContext.ApplicationInstance.Response, HttpReadType.Save);
            }
    ...
    {
        public static DocIoResult ExportAsAction_Result(this PdfDocument PdfDoc, string filename, HttpResponse response, HttpReadType type)
        {
            return new DocIoResult(PdfDoc, filename, response, type);
        }
        public static DocIoResult ExportAsAction_Result(this PdfXfaDocument PdfDoc, string filename, PdfXfaType xfaType, HttpResponse response, HttpReadType type)
        {
            return new DocIoResult(PdfDoc, filename, xfaType, response, type);
        }
        public static DocIoResult ExportAsAction_Result(this PdfLoadedDocument pdfdoc, string filename, HttpResponse response, HttpReadType type)
        {
            return new DocIoResult(pdfdoc, filename, response, type);
        }
        public static DocIoResult ExportAsAction_Result(this PdfLoadedXfaDocument pdfdoc, string filename, HttpResponse response, HttpReadType type, bool isxfa)
        {
            return new DocIoResult(pdfdoc, filename, response, type, isxfa);
        }
    }
    public class DocIoResult : ActionResult
    {
        private string m_filename;
        ...
        public DocIoResult(PdfDocument pdfDocument, string filename, HttpResponse respone, HttpReadType type)
        {
        ...
        public DocIoResult(PdfLoadedDocument pdfLoadedDocument, string filename, HttpResponse respone, HttpReadType type)
        {
        ...
        public DocIoResult(PdfXfaDocument pdfDocument, string filename, PdfXfaType xfaType, HttpResponse respone, HttpReadType type)
        {
        ...
        public DocIoResult(PdfLoadedXfaDocument pdfLoadedDocument, string filename, HttpResponse respone, HttpReadType type, bool isxfa)
        {
            this.m_pdfDocument = null;
